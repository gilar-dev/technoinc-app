...
export const blockMenuList: BlockMenuList = {
    general: [
        ...
        { label: "Image", icon: "fa-solid fa-image", block: () => ({ type: "gen-image-type", src: "", public_id: "" }) }
    ...
    infobox: [
        ...
        { label: "Ib Image", icon: "fa-solid fa-image p-1 border", block: () => ({ type: "ib-image-type", src: "", public_id: "" }) }
    ]
}